...
# 保存截图
save_path = 'C:\Sunaoxue\IT_Project/NSM/Data/test_name'
    ...
    if pre_frame is None:
        ...
        for c in contours:
            ...
            if cv2.contourArea(c) < 1000:
                ...
                Name = str(time.strftime('%Y-%m-%d_%H%M%S', time.localtime(time.time())))

                fn = ('C:\Sunaoxue\IT_Project/NSM\Data/test_name/shot%s.jpg' % Name )
                time.sleep(10)
