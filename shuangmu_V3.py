...
pointCloudX, pointCloudY, pointCloudZ, reprojError = cv2.triangulatePoints(points1, points2, K, E, P, P1)
positionX, positionY, positionZ = cv2.transformToPosition(pointCloudX, pointCloudY, pointCloudZ, P1, K, scale=10.0)
